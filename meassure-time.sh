...
do
  ...
  time ./main-rsa "${OUTPUT_PATH}/${FILE}.enc" "${OUTPUT_PATH}/${FILE}.dec" "${OUTPUT_PATH}/private-1024" -decrypt
  ...
  time ./main-rsa "${OUTPUT_PATH}/${FILE}.enc" "${OUTPUT_PATH}/${FILE}.dec" "${OUTPUT_PATH}/private-2048" -decrypt
  ...
  time ./main-rsa "${OUTPUT_PATH}/${FILE}.enc" "${OUTPUT_PATH}/${FILE}.dec" "${OUTPUT_PATH}/private-4096" -decrypt
